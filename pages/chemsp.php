...
//                                                  { $filename  = "${field}_$mathflag$verification.$season.gif"; } 
     ...
     if (file_exists("../$year/$filenamez"))         { $zrefz = "<a href=../$year/$filenamez         target=''> <font color=darkred> (z) </font> </a>"; } 
     if (file_exists("../$year/$season/$filenamez")) { $zrefz = "<a href=../$year/$season/$filenamez target=''> <font color=darkred> (z) </font> </a>"; } 

     if (file_exists("../$year/$filename"))         { $zref = "<a href=../$year/$filename target=''>         <font color=${fcolor}> $field </a>"; } 
     if (file_exists("../$year/$season/$filename")) { $zref = "<a href=../$year/$season/$filename target=''> <font color=${fcolor}> $field </a>"; } 
