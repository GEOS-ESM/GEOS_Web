...
echo $content;
      ...
      mk_link1 ("../$year/olr_z_ERBE.${seasonUC}.gif","(z)","darkred");
      mk_link2 ("../$year/olr_ERBE.${seasonUC}.gif","Outgoing Longwave Radiation (All-Sky)","blue");

      mk_link1 ("../$year/olrc_z_ERBE.${seasonUC}.gif","(z)","darkred");
      mk_link2 ("../$year/olrc_ERBE.${seasonUC}.gif","Outgoing Longwave Radiation (Clear-Sky)","blue");

      mk_link1 ("../$year/olrcf_z_ERBE.${seasonUC}.gif","(z)","darkred");
      mk_link2 ("../$year/olrcf_ERBE.${seasonUC}.gif","TOA Longwave Radiation Cloud Forcing","blue");
...
echo $content;
      ...
      mk_link1 ("../$year/osr_z_ERBE.${seasonUC}.gif","(z)","darkred");
      mk_link2 ("../$year/osr_ERBE.${seasonUC}.gif","Net TOA Shortwave Radiation (All-Sky)","blue");

      mk_link1 ("../$year/osrc_z_ERBE.${seasonUC}.gif","(z)","darkred");
      mk_link2 ("../$year/osrc_ERBE.${seasonUC}.gif","Net TOA Shortwave Radiation (Clear-Sky)","blue");

      mk_link1 ("../$year/osrcf_z_ERBE.${seasonUC}.gif","(z)","darkred");
      mk_link2 ("../$year/osrcf_ERBE.${seasonUC}.gif","Net TOA Shortwave Radiation Cloud Forcing","blue");
